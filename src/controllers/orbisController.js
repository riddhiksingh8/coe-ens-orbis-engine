...
//            console.log(`Filtered Events: ${default_events.length}`);
        ...
        if (data) {
            ...
            response = {
                ...
                address: [data.ADDRESS_LINE1, data.ADDRESS_LINE2, data.ADDRESS_LINE3, data.ADDRESS_LINE4,data.POSTCODE, data.CITY_STANDARDIZED, data.COUNTRY].filter(Boolean).join(', ') || null,
